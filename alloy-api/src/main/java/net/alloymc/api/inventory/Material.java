...
public enum Material {
    ...
    COAL(false, false),
    CHARCOAL(false, false),
    IRON_INGOT(false, false),
    GOLD_INGOT(false, false),
    COPPER_INGOT(false, false),
    DIAMOND(false, false),
    EMERALD(false, false),
    LAPIS_LAZULI(false, false),
    NETHERITE_INGOT(false, false),
    NETHERITE_SCRAP(false, false),
    IRON_NUGGET(false, false),
    GOLD_NUGGET(false, false),
    RAW_IRON(false, false),
    RAW_GOLD(false, false),
    RAW_COPPER(false, false),
    QUARTZ(false, false),
    REDSTONE(false, false),
    GLOWSTONE_DUST(false, false),
    GUNPOWDER(false, false),
    BLAZE_ROD(false, false),
    BLAZE_POWDER(false, false),
    NETHER_STAR(false, false),

    // Food items
    APPLE(false, false),
    GOLDEN_APPLE(false, false),
    ENCHANTED_GOLDEN_APPLE(false, false),
    BREAD(false, false),
    COOKED_BEEF(false, false),
    COOKED_PORKCHOP(false, false),
    COOKED_CHICKEN(false, false),
    COOKED_SALMON(false, false),
    COOKED_COD(false, false),
    COOKED_MUTTON(false, false),
    COOKED_RABBIT(false, false),
    COOKIE(false, false),
    PUMPKIN_PIE(false, false),
    MELON_SLICE(false, false),
    ...
    LEATHER(false, false),
    ARROW(false, false),
    SPECTRAL_ARROW(false, false),
    SLIME_BALL(false, false),
    INK_SAC(false, false),
    GLOW_INK_SAC(false, false),
    GLASS_BOTTLE(false, false),
    EXPERIENCE_BOTTLE(false, false),
